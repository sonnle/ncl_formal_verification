...
(assert
	(not
		...
		(let
			(
				(S2x6 ((_ extract 3 2) (fa and5x1 C1x5 C2x5 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C2x6 ((_ extract 1 0) (fa and5x1 C1x5 C2x5 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S3x6 ((_ extract 3 2) (fa and4x2 S2x6 C3x5 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C3x6 ((_ extract 1 0) (fa and4x2 S2x6 C3x5 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S3x7 ((_ extract 3 2) (fa and5x2 C2x6 C3x6 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C3x7 ((_ extract 1 0) (fa and5x2 C2x6 C3x6 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S4x6 ((_ extract 3 2) (fa and3x3 S3x6 C4x5 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C4x6 ((_ extract 1 0) (fa and3x3 S3x6 C4x5 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S4x7 ((_ extract 3 2) (fa and4x3 S3x7 C4x6 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C4x7 ((_ extract 1 0) (fa and4x3 S3x7 C4x6 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S4x8 ((_ extract 3 2) (fa and5x3 C3x7 C4x7 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C4x8 ((_ extract 1 0) (fa and5x3 C3x7 C4x7 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S5x6 ((_ extract 3 2) (fa and2x4 S4x6 C5x5 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C5x6 ((_ extract 1 0) (fa and2x4 S4x6 C5x5 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S5x7 ((_ extract 3 2) (fa and3x4 S4x7 C5x6 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C5x7 ((_ extract 1 0) (fa and3x4 S4x7 C5x6 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S5x9 ((_ extract 3 2) (fa and5x4 C4x8 C5x8 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C5x9 ((_ extract 1 0) (fa and5x4 C4x8 C5x8 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S6x6 ((_ extract 3 2) (ha and1x5 S5x6 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C6x6 ((_ extract 1 0) (ha and1x5 S5x6 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S6x7 ((_ extract 3 2) (fa and2x5 S5x7 C6x6 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C6x7 ((_ extract 1 0) (fa and2x5 S5x7 C6x6 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S6x10 ((_ extract 3 2) (fa and5x5 C5x9 C6x9 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C6x10 ((_ extract 1 0) (fa and5x5 C5x9 C6x9 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(Z0 S0x0)
        ...
        (let
            (
                (Pncl (concat (rail1 Z11) (rail1 Z10) (rail1 Z9) (rail1 Z8) (rail1 Z7) (rail1 Z6) (rail1 Z5) (rail1 Z4) (rail1 Z3) (rail1 Z2) (rail1 Z1) (rail1 Z0)))
            )
        (let
			(
        ...
        (let
            (
                (ACCncl (concat (rail1 ACCo11) (rail1 ACCo10) (rail1 ACCo9) (rail1 ACCo8) (rail1 ACCo7) (rail1 ACCo6) (rail1 ACCo5) (rail1 ACCo4) (rail1 ACCo3) (rail1 ACCo2) (rail1 ACCo1) (rail1 ACCo0)))
            )
        (let
			(
                (Psync (bvmul (concat (_ bv0 6) (rail1 Xi5) (rail1 Xi4) (rail1 Xi3) (rail1 Xi2) (rail1 Xi1) (rail1 Xi0)) (concat (_ bv0 6) (rail1 Yi5) (rail1 Yi4) (rail1 Yi3) (rail1 Yi2) (rail1 Yi1) (rail1 Yi0))))
            )
        (let
            (
                (ACCpre (bvadd Psync (concat (rail1 ACCi11) (rail1 ACCi10) (rail1 ACCi9) (rail1 ACCi8) (rail1 ACCi7) (rail1 ACCi6) (rail1 ACCi5) (rail1 ACCi4) (rail1 ACCi3) (rail1 ACCi2) (rail1 ACCi1) (rail1 ACCi0))))
            )
		(let
			(
		...
		(let
			(
				(ACCsync (concat ACCreg11 ACCreg10 ACCreg9 ACCreg8 ACCreg7 ACCreg6 ACCreg5 ACCreg4 ACCreg3 ACCreg2 ACCreg1 ACCreg0))
			)
        (=>
            (and
                (= (_ bv0 1) Gc_0)
