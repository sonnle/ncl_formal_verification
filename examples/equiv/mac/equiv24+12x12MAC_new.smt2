	...
	(not
		(let
			(
				...
				(ACC22 (REG_NULL ACCi22 Ki0 RST CS0))
				(ACC23 (REG_NULL ACCi23 Ki0 RST CS0))
			)
		(let
			(
        ...
        (let
            (
                (Pncl (concat (rail1 Z19) (rail1 Z18) (rail1 Z17) (rail1 Z16) (rail1 Z15) (rail1 Z14) (rail1 Z13) (rail1 Z12) (rail1 Z11) (rail1 Z10) (rail1 Z9) (rail1 Z8) (rail1 Z7) (rail1 Z6) (rail1 Z5) (rail1 Z4) (rail1 Z3) (rail1 Z2) (rail1 Z1) (rail1 Z0)))
            )
        (let
			(
        ...
        (let
			(
				...
				(ACCo22 (REG_DATA0 P22 Ki1 RST CS1))
				(ACCo23 (REG_DATA0 P23 Ki1 RST CS1))
			)
        (let
            (
                (ACCncl (concat (rail1 ACCo23) (rail1 ACCo22) (rail1 ACCo21) (rail1 ACCo20) (rail1 ACCo19) (rail1 ACCo18) (rail1 ACCo17) (rail1 ACCo16) (rail1 ACCo15) (rail1 ACCo14) (rail1 ACCo13) (rail1 ACCo12) (rail1 ACCo11) (rail1 ACCo10) (rail1 ACCo9) (rail1 ACCo8) (rail1 ACCo7) (rail1 ACCo6) (rail1 ACCo5) (rail1 ACCo4) (rail1 ACCo3) (rail1 ACCo2) (rail1 ACCo1) (rail1 ACCo0)))
            )
        (let
			(
                (Psync (bvmul (concat (_ bv0 12) (rail1 Xi11) (rail1 Xi10) (rail1 Xi9) (rail1 Xi8) (rail1 Xi7) (rail1 Xi6) (rail1 Xi5) (rail1 Xi4) (rail1 Xi3) (rail1 Xi2) (rail1 Xi1) (rail1 Xi0)) (concat (_ bv0 12) (rail1 Yi11) (rail1 Yi10) (rail1 Yi9) (rail1 Yi8) (rail1 Yi7) (rail1 Yi6) (rail1 Yi5) (rail1 Yi4) (rail1 Yi3) (rail1 Yi2) (rail1 Yi1) (rail1 Yi0))))
            )
        (let
            (
                (ACCpre (bvadd Psync (concat (rail1 ACCi23) (rail1 ACCi22) (rail1 ACCi21) (rail1 ACCi20) (rail1 ACCi19) (rail1 ACCi18) (rail1 ACCi17) (rail1 ACCi16) (rail1 ACCi15) (rail1 ACCi14) (rail1 ACCi13) (rail1 ACCi12) (rail1 ACCi11) (rail1 ACCi10) (rail1 ACCi9) (rail1 ACCi8) (rail1 ACCi7) (rail1 ACCi6) (rail1 ACCi5) (rail1 ACCi4) (rail1 ACCi3) (rail1 ACCi2) (rail1 ACCi1) (rail1 ACCi0))))
            )
		(let
			(
				...
				(ACCreg22 (REG0 ((_ extract 22 22) ACCpre) Ki1 RST (rail1 CS1)))
				(ACCreg23 (REG0 ((_ extract 23 23) ACCpre) Ki1 RST (rail1 CS1)))
			)
		(let
			(
				(ACCsync (concat ACCreg23 ACCreg22 ACCreg21 ACCreg20 ACCreg19 ACCreg18 ACCreg17 ACCreg16 ACCreg15 ACCreg14 ACCreg13 ACCreg12 ACCreg11 ACCreg10 ACCreg9 ACCreg8 ACCreg7 ACCreg6 ACCreg5 ACCreg4 ACCreg3 ACCreg2 ACCreg1 ACCreg0))
			)
        (=>
            (and
                (= (_ bv0 1) Gc_0)
