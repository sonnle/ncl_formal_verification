(set-logic QF_BV)
; Inputs: X0 X1 X2 X3 X4 X5 X6 Y0 Y1 Y2 Y3 Y4 Y5 Y6
...
; Outputs: Z0 Z1 Z2 Z3 Z4 Z5 Z6 Z7 Z8 Z9 Z10 Z11 Z12 Z13
...
(let
(
(C2x7_1 (th23 and6x1_1 C1x6_1 C2x6_1 Gc_0))
(C2x7_0 (th23 and6x1_0 C1x6_0 C2x6_0 Gc_0))
...
(S2x7_1 (th34w2 C2x7_0 and6x1_1 C1x6_1 C2x6_1 Gc_0))
(S2x7_0 (th34w2 C2x7_1 and6x1_0 C1x6_0 C2x6_0 Gc_0))
...
(C3x7_0 (th23 and5x2_0 S2x7_0 C3x6_0 Gc_0))
(C3x7_1 (th23 and5x2_1 S2x7_1 C3x6_1 Gc_0))
)
(let
(
(S4x5_1 (th34w2 C4x5_0 and1x4_1 S3x5_1 C4x4_1 Gc_0))
(S4x5_0 (th34w2 C4x5_1 and1x4_0 S3x5_0 C4x4_0 Gc_0))
(C3x8_1 (th23 and6x2_1 C2x7_1 C3x7_1 Gc_0))
(C3x8_0 (th23 and6x2_0 C2x7_0 C3x7_0 Gc_0))
(S3x7_0 (th34w2 C3x7_1 and5x2_0 S2x7_0 C3x6_0 Gc_0))
(S3x7_1 (th34w2 C3x7_0 and5x2_1 S2x7_1 C3x6_1 Gc_0))
...
(S3x8_1 (th34w2 C3x8_0 and6x2_1 C2x7_1 C3x7_1 Gc_0))
(S3x8_0 (th34w2 C3x8_1 and6x2_0 C2x7_0 C3x7_0 Gc_0))
...
(C4x9_1 (th23 and6x3_1 C3x8_1 C4x8_1 Gc_0))
(C4x9_0 (th23 and6x3_0 C3x8_0 C4x8_0 Gc_0))
)
(let
(
(C6x6_0 (th12 S5x6_0 and0x6_0 Gc_0))
(C6x6_1 (th22 S5x6_1 and0x6_1 Gc_0))
(S4x9_1 (th34w2 C4x9_0 and6x3_1 C3x8_1 C4x8_1 Gc_0))
(S4x9_0 (th34w2 C4x9_1 and6x3_0 C3x8_0 C4x8_0 Gc_0))
...
(let
(
(C5x10_1 (th23 and6x4_1 C4x9_1 C5x9_1 Gc_0))
(C5x10_0 (th23 and6x4_0 C4x9_0 C5x9_0 Gc_0))
(S6x7_1 (th34w2 C6x7_0 and2x5_1 S5x7_1 C6x6_1 Gc_0))
(S6x7_0 (th34w2 C6x7_1 and2x5_0 S5x7_0 C6x6_0 Gc_0))
...
(C7x7_1 (th22 S6x7_1 and1x6_1 Gc_0))
(S6x8_0 (th34w2 C6x8_1 and3x5_0 S5x8_0 C6x7_0 Gc_0))
(S6x8_1 (th34w2 C6x8_0 and3x5_1 S5x8_1 C6x7_1 Gc_0))
(S5x10_1 (th34w2 C5x10_0 and6x4_1 C4x9_1 C5x9_1 Gc_0))
(S5x10_0 (th34w2 C5x10_1 and6x4_0 C4x9_0 C5x9_0 Gc_0))
(C7x7_0 (th12 S6x7_0 and1x6_0 Gc_0))
(Z7_0 (th24comp S6x7_0 and1x6_1 and1x6_0 S6x7_1 Gc_0))
(Z7_1 (th24comp S6x7_0 and1x6_0 S6x7_1 and1x6_1 Gc_0))
)
(let
(
...
(let
(
(Z8_1 (th34w2 C7x8_0 and2x6_1 S6x8_1 C7x7_1 Gc_0))
(Z8_0 (th34w2 C7x8_1 and2x6_0 S6x8_0 C7x7_0 Gc_0))
(S6x10_0 (th34w2 C6x10_1 and5x5_0 S5x10_0 C6x9_0 Gc_0))
(S6x10_1 (th34w2 C6x10_0 and5x5_1 S5x10_1 C6x9_1 Gc_0))
(C6x11_1 (th23 and6x5_1 C5x10_1 C6x10_1 Gc_0))
(C6x11_0 (th23 and6x5_0 C5x10_0 C6x10_0 Gc_0))
...
(Z9_0 (th34w2 C7x9_1 and3x6_0 S6x9_0 C7x8_0 Gc_0))
(Z9_1 (th34w2 C7x9_0 and3x6_1 S6x9_1 C7x8_1 Gc_0))
(S6x11_1 (th34w2 C6x11_0 and6x5_1 C5x10_1 C6x10_1 Gc_0))
(S6x11_0 (th34w2 C6x11_1 and6x5_0 C5x10_0 C6x10_0 Gc_0))
)
(let
(
(Z10_1 (th34w2 C7x10_0 and4x6_1 S6x10_1 C7x9_1 Gc_0))
(Z10_0 (th34w2 C7x10_1 and4x6_0 S6x10_0 C7x9_0 Gc_0))
(C7x11_0 (th23 and5x6_0 S6x11_0 C7x10_0 Gc_0))
(C7x11_1 (th23 and5x6_1 S6x11_1 C7x10_1 Gc_0))
)
(let
(
(Z13_0 (th23 and6x6_0 C6x11_0 C7x11_0 Gc_0))
(Z13_1 (th23 and6x6_1 C6x11_1 C7x11_1 Gc_0))
(Z11_0 (th34w2 C7x11_1 and5x6_0 S6x11_0 C7x10_0 Gc_0))
(Z11_1 (th34w2 C7x11_0 and5x6_1 S6x11_1 C7x10_1 Gc_0))
)
(let
(
(Z12_1 (th34w2 Z13_0 and6x6_1 C6x11_1 C7x11_1 Gc_0))
(Z12_0 (th34w2 Z13_1 and6x6_0 C6x11_0 C7x11_0 Gc_0))
)
(let
(
(Z0 (concat Z0_1 Z0_0))
...
(let
(
(I15_sync (bvxor and1x2_sync S1x3_sync)) 
(I17_sync (bvand and1x2_sync S1x3_sync)) 
(C1x3_sync (bvor I4_sync I5_sync)) 
)
(let
(
(S1x4_sync (bvxor I6_sync C1x3_sync)) 
(I16_sync (bvand I15_sync C2x2_sync)) 
(S2x3_sync (bvxor I15_sync C2x2_sync)) 
(I7_sync (bvand I6_sync C1x3_sync)) 
)
(let
(
(C1x4_sync (bvor I7_sync I8_sync)) 
(I18_sync (bvxor and2x2_sync S1x4_sync)) 
(I20_sync (bvand and2x2_sync S1x4_sync)) 
(C2x3_sync (bvor I16_sync I17_sync)) 
...
(S2x4_sync (bvxor I18_sync C2x3_sync)) 
(I19_sync (bvand I18_sync C2x3_sync)) 
(I10_sync (bvand I9_sync C1x4_sync)) 
)
(let
(
(C1x5_sync (bvor I10_sync I11_sync)) 
(C2x4_sync (bvor I19_sync I20_sync)) 
(I30_sync (bvxor and1x3_sync S2x4_sync)) 
(I32_sync (bvand and1x3_sync S2x4_sync)) 
(I23_sync (bvand and3x2_sync S1x5_sync)) 
(I21_sync (bvxor and3x2_sync S1x5_sync)) 
)
(let
(
(S3x4_sync (bvxor I30_sync C3x3_sync)) 
(I31_sync (bvand I30_sync C3x3_sync)) 
(I13_sync (bvand I12_sync C1x5_sync)) 
(S1x6_sync (bvxor I12_sync C1x5_sync)) 
(S2x5_sync (bvxor I21_sync C2x4_sync)) 
(I22_sync (bvand I21_sync C2x4_sync)) 
)
(let
(
(C1x6_sync (bvor I13_sync I14_sync)) 
(I33_sync (bvxor and2x3_sync S2x5_sync)) 
(C2x5_sync (bvor I22_sync I23_sync)) 
(I24_sync (bvxor and4x2_sync S1x6_sync)) 
(I35_sync (bvand and2x3_sync S2x5_sync)) 
(C3x4_sync (bvor I31_sync I32_sync)) 
(I26_sync (bvand and4x2_sync S1x6_sync)) 
(Z4_sync (bvxor and0x4_sync S3x4_sync)) 
(C4x4_sync (bvand and0x4_sync S3x4_sync)) 
)
(let
(
(I29_sync (bvand and6x1_sync C1x6_sync)) 
(S3x5_sync (bvxor I33_sync C3x4_sync)) 
(I25_sync (bvand I24_sync C2x5_sync)) 
(I27_sync (bvxor and6x1_sync C1x6_sync)) 
(S2x6_sync (bvxor I24_sync C2x5_sync)) 
(I34_sync (bvand I33_sync C3x4_sync)) 
)
(let
(
(I38_sync (bvand and3x3_sync S2x6_sync)) 
(C2x6_sync (bvor I25_sync I26_sync)) 
(I36_sync (bvxor and3x3_sync S2x6_sync)) 
(C3x5_sync (bvor I34_sync I35_sync)) 
(I47_sync (bvand and1x4_sync S3x5_sync)) 
(I45_sync (bvxor and1x4_sync S3x5_sync)) 
)
(let
(
(I28_sync (bvand I27_sync C2x6_sync)) 
(S3x6_sync (bvxor I36_sync C3x5_sync)) 
(S4x5_sync (bvxor I45_sync C4x4_sync)) 
(I37_sync (bvand I36_sync C3x5_sync)) 
(S2x7_sync (bvxor I27_sync C2x6_sync)) 
(I46_sync (bvand I45_sync C4x4_sync)) 
)
(let
(
(I39_sync (bvxor and5x2_sync S2x7_sync)) 
(C2x7_sync (bvor I28_sync I29_sync)) 
(C3x6_sync (bvor I37_sync I38_sync)) 
(C5x5_sync (bvand and0x5_sync S4x5_sync)) 
(I48_sync (bvxor and2x4_sync S3x6_sync)) 
(Z5_sync (bvxor and0x5_sync S4x5_sync)) 
(I50_sync (bvand and2x4_sync S3x6_sync)) 
(C4x5_sync (bvor I46_sync I47_sync)) 
(I41_sync (bvand and5x2_sync S2x7_sync)) 
)
(let
(
(S3x7_sync (bvxor I39_sync C3x6_sync)) 
(S4x6_sync (bvxor I48_sync C4x5_sync)) 
(I49_sync (bvand I48_sync C4x5_sync)) 
(I44_sync (bvand and6x2_sync C2x7_sync)) 
(I42_sync (bvxor and6x2_sync C2x7_sync)) 
(I40_sync (bvand I39_sync C3x6_sync)) 
)
(let
(
(C3x7_sync (bvor I40_sync I41_sync)) 
(I60_sync (bvxor and1x5_sync S4x6_sync)) 
(I62_sync (bvand and1x5_sync S4x6_sync)) 
(I51_sync (bvxor and4x3_sync S3x7_sync)) 
(I53_sync (bvand and4x3_sync S3x7_sync)) 
(C4x6_sync (bvor I49_sync I50_sync)) 
)
(let
(
(S5x6_sync (bvxor I60_sync C5x5_sync)) 
(S3x8_sync (bvxor I42_sync C3x7_sync)) 
(S4x7_sync (bvxor I51_sync C4x6_sync)) 
(I52_sync (bvand I51_sync C4x6_sync)) 
(I43_sync (bvand I42_sync C3x7_sync)) 
(I61_sync (bvand I60_sync C5x5_sync)) 
)
(let
(
(C6x6_sync (bvand and0x6_sync S5x6_sync)) 
(I65_sync (bvand and3x4_sync S4x7_sync)) 
(C4x7_sync (bvor I52_sync I53_sync)) 
(C5x6_sync (bvor I61_sync I62_sync)) 
(I63_sync (bvxor and3x4_sync S4x7_sync)) 
(Z6_sync (bvxor and0x6_sync S5x6_sync)) 
(I54_sync (bvxor and5x3_sync S3x8_sync)) 
(C3x8_sync (bvor I43_sync I44_sync)) 
(I56_sync (bvand and5x3_sync S3x8_sync)) 
)
(let
(
(S4x8_sync (bvxor I54_sync C4x7_sync)) 
(S5x7_sync (bvxor I63_sync C5x6_sync)) 
(I59_sync (bvand and6x3_sync C3x8_sync)) 
(I64_sync (bvand I63_sync C5x6_sync)) 
(I55_sync (bvand I54_sync C4x7_sync)) 
(I57_sync (bvxor and6x3_sync C3x8_sync)) 
)
(let
(
(I66_sync (bvxor and4x4_sync S4x8_sync)) 
(I77_sync (bvand and2x5_sync S5x7_sync)) 
(C4x8_sync (bvor I55_sync I56_sync)) 
(I75_sync (bvxor and2x5_sync S5x7_sync)) 
(C5x7_sync (bvor I64_sync I65_sync)) 
(I68_sync (bvand and4x4_sync S4x8_sync)) 
)
(let
(
(S4x9_sync (bvxor I57_sync C4x8_sync)) 
(I58_sync (bvand I57_sync C4x8_sync)) 
(S5x8_sync (bvxor I66_sync C5x7_sync)) 
(S6x7_sync (bvxor I75_sync C6x6_sync)) 
(I76_sync (bvand I75_sync C6x6_sync)) 
(I67_sync (bvand I66_sync C5x7_sync)) 
)
(let
(
(C4x9_sync (bvor I58_sync I59_sync)) 
(C7x7_sync (bvand and1x6_sync S6x7_sync)) 
(I71_sync (bvand and5x4_sync S4x9_sync)) 
(C5x8_sync (bvor I67_sync I68_sync)) 
(I80_sync (bvand and3x5_sync S5x8_sync)) 
(Z7_sync (bvxor and1x6_sync S6x7_sync)) 
(C6x7_sync (bvor I76_sync I77_sync)) 
(I69_sync (bvxor and5x4_sync S4x9_sync)) 
(I78_sync (bvxor and3x5_sync S5x8_sync)) 
)
(let
(
(S6x8_sync (bvxor I78_sync C6x7_sync)) 
(S5x9_sync (bvxor I69_sync C5x8_sync)) 
(I74_sync (bvand and6x4_sync C4x9_sync)) 
(I72_sync (bvxor and6x4_sync C4x9_sync)) 
(I70_sync (bvand I69_sync C5x8_sync)) 
(I79_sync (bvand I78_sync C6x7_sync)) 
)
(let
(
(I92_sync (bvand and2x6_sync S6x8_sync)) 
(C6x8_sync (bvor I79_sync I80_sync)) 
(I90_sync (bvxor and2x6_sync S6x8_sync)) 
(C5x9_sync (bvor I70_sync I71_sync)) 
(I83_sync (bvand and4x5_sync S5x9_sync)) 
(I81_sync (bvxor and4x5_sync S5x9_sync)) 
)
(let
(
(S6x9_sync (bvxor I81_sync C6x8_sync)) 
(I91_sync (bvand I90_sync C7x7_sync)) 
(Z8_sync (bvxor I90_sync C7x7_sync)) 
(I82_sync (bvand I81_sync C6x8_sync)) 
(I73_sync (bvand I72_sync C5x9_sync)) 
(S5x10_sync (bvxor I72_sync C5x9_sync)) 
)
(let
(
(C5x10_sync (bvor I73_sync I74_sync)) 
(I95_sync (bvand and3x6_sync S6x9_sync)) 
(C6x9_sync (bvor I82_sync I83_sync)) 
(I93_sync (bvxor and3x6_sync S6x9_sync)) 
(C7x8_sync (bvor I91_sync I92_sync)) 
(I86_sync (bvand and5x5_sync S5x10_sync)) 
(I84_sync (bvxor and5x5_sync S5x10_sync)) 
)
(let
(
(I94_sync (bvand I93_sync C7x8_sync)) 
(I89_sync (bvand and6x5_sync C5x10_sync)) 
(Z9_sync (bvxor I93_sync C7x8_sync)) 
(I85_sync (bvand I84_sync C6x9_sync)) 
(I87_sync (bvxor and6x5_sync C5x10_sync)) 
(S6x10_sync (bvxor I84_sync C6x9_sync)) 
)
(let
(
(I96_sync (bvxor and4x6_sync S6x10_sync)) 
(C7x9_sync (bvor I94_sync I95_sync)) 
(I98_sync (bvand and4x6_sync S6x10_sync)) 
(C6x10_sync (bvor I85_sync I86_sync)) 
)
(let
(
(S6x11_sync (bvxor I87_sync C6x10_sync)) 
(I97_sync (bvand I96_sync C7x9_sync)) 
(I88_sync (bvand I87_sync C6x10_sync)) 
(Z10_sync (bvxor I96_sync C7x9_sync)) 
)
(let
(
(C7x10_sync (bvor I97_sync I98_sync)) 
(I99_sync (bvxor and5x6_sync S6x11_sync)) 
(C6x11_sync (bvor I88_sync I89_sync)) 
(I101_sync (bvand and5x6_sync S6x11_sync)) 
)
(let
(
(I104_sync (bvand and6x6_sync C6x11_sync)) 
(I102_sync (bvxor and6x6_sync C6x11_sync)) 
(I100_sync (bvand I99_sync C7x10_sync)) 
(Z11_sync (bvxor I99_sync C7x10_sync)) 
)
(let
(
(C7x11_sync (bvor I100_sync I101_sync)) 
)
(let
(
(Z12_sync (bvxor I102_sync C7x11_sync)) 
(I103_sync (bvand I102_sync C7x11_sync)) 
)
(let
(
(Z13_sync (bvor I103_sync I104_sync)) 
)
(=>
(and
(datap X0)
