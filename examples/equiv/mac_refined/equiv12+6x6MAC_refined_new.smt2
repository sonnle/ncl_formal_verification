	...
	(not
		...
		(let
			(
				...
				(Z7_1 ((_ extract 1 1) S6x7))
				(Z8_1 ((_ extract 1 1) S6x8))
				(Z9_1 ((_ extract 1 1) S6x9))
				(Z10_1 ((_ extract 1 1) S6x10))
				(Z11_1 ((_ extract 1 1) C6x10))
			)
		(let
			(
        ...
        (let
            (
                (ACCncl (concat ACCo11_1 ACCo10_1 ACCo9_1 ACCo8_1 ACCo7_1 ACCo6_1 ACCo5_1 ACCo4_1 ACCo3_1 ACCo2_1 ACCo1_1 ACCo0_1))
            )
        (let
			(
                (Psync (bvmul (concat (_ bv0 6) X5_1 X4_1 X3_1 X2_1 X1_1 X0_1) (concat (_ bv0 6) Y5_1 Y4_1 Y3_1 Y2_1 Y1_1 Y0_1)))
            )
        (let
            (
                (ACCsync (bvadd Psync (concat (rail1 ACCi11) (rail1 ACCi10) (rail1 ACCi9) (rail1 ACCi8) (rail1 ACCi7) (rail1 ACCi6) (rail1 ACCi5) (rail1 ACCi4) (rail1 ACCi3) (rail1 ACCi2) (rail1 ACCi1) (rail1 ACCi0))))
            )
        (=>
            (and
                (= (_ bv0 1) Gc_0)
