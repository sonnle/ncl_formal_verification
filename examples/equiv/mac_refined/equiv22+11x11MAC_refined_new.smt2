	...
	(not
		...
		(let
			(
				...
				(Z12_1 ((_ extract 1 1) S11x12))
				(Z13_1 ((_ extract 1 1) S11x13))
				(Z14_1 ((_ extract 1 1) S11x14))
				(Z15_1 ((_ extract 1 1) S11x15))
				(Z16_1 ((_ extract 1 1) S11x16))
				(Z17_1 ((_ extract 1 1) S11x17))
				(Z18_1 ((_ extract 1 1) S11x18))
				(Z19_1 ((_ extract 1 1) S11x19))
				(Z20_1 ((_ extract 1 1) S11x20))
				(Z21_1 ((_ extract 1 1) C11x20))
			)
		(let
			(
        ...
        (let
            (
                (ACCncl (concat ACCo21_1 ACCo20_1 ACCo19_1 ACCo18_1 ACCo17_1 ACCo16_1 ACCo15_1 ACCo14_1 ACCo13_1 ACCo12_1 ACCo11_1 ACCo10_1 ACCo9_1 ACCo8_1 ACCo7_1 ACCo6_1 ACCo5_1 ACCo4_1 ACCo3_1 ACCo2_1 ACCo1_1 ACCo0_1))
            )
        (let
			(
                (Psync (bvmul (concat (_ bv0 11) X10_1 X9_1 X8_1 X7_1 X6_1 X5_1 X4_1 X3_1 X2_1 X1_1 X0_1) (concat (_ bv0 11) Y10_1 Y9_1 Y8_1 Y7_1 Y6_1 Y5_1 Y4_1 Y3_1 Y2_1 Y1_1 Y0_1)))
            )
        (let
            (
                (ACCsync (bvadd Psync (concat ACC21_1 ACC20_1 ACC19_1 ACC18_1 ACC17_1 ACC16_1 ACC15_1 ACC14_1 ACC13_1 ACC12_1 ACC11_1 ACC10_1 ACC9_1 ACC8_1 ACC7_1 ACC6_1 ACC5_1 ACC4_1 ACC3_1 ACC2_1 ACC1_1 ACC0_1)))
            )
        (=>
            (and
                (= (_ bv0 1) Gc_0)
