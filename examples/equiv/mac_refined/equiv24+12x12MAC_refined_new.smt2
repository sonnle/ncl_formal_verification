...
(declare-fun ACCi22 () (_ BitVec 2))
(declare-fun ACCi23 () (_ BitVec 2))
	...
	(not
		(let
			(
				...
				(X10_1 ((_ extract 1 1) Xi10))
				(X11_1 ((_ extract 1 1) Xi11))
				...
				(Y10_1 ((_ extract 1 1) Yi10))
				(Y11_1 ((_ extract 1 1) Yi11))
				...
				(ACC20_1 ((_ extract 1 1) ACCi20))
				(ACC21_1 ((_ extract 1 1) ACCi21))
				(ACC22_1 ((_ extract 1 1) ACCi22))
				(ACC23_1 ((_ extract 1 1) ACCi23))
			)
		(let
			(
				...
				(X10 (concat X10_1 (bvnot X10_1)))
				(X11 (concat X11_1 (bvnot X11_1)))
				...
				(Y10 (concat Y10_1 (bvnot Y10_1)))
				(Y11 (concat Y11_1 (bvnot Y11_1)))
				...
				(ACC20 (concat ACC20_1 (bvnot ACC20_1)))
				(ACC21 (concat ACC21_1 (bvnot ACC21_1)))
				(ACC22 (concat ACC22_1 (bvnot ACC22_1)))
				(ACC23 (concat ACC23_1 (bvnot ACC23_1)))
			)
		(let
			(
				...
				(and0x11 (and2_incomplete X0 Y11 Gc_0 Gc_0))
				...
				(and1x11 (and2_incomplete X1 Y11 Gc_0 Gc_0))
				...
				(and2x11 (and2_incomplete X2 Y11 Gc_0 Gc_0))
				...
				(and3x11 (and2_incomplete X3 Y11 Gc_0 Gc_0))
				...
				(and4x11 (and2_incomplete X4 Y11 Gc_0 Gc_0))
				...
				(and5x11 (and2_incomplete X5 Y11 Gc_0 Gc_0))
				...
				(and6x11 (and2_incomplete X6 Y11 Gc_0 Gc_0))
				...
				(and7x11 (and2_incomplete X7 Y11 Gc_0 Gc_0))
				...
				(and8x11 (and2_incomplete X8 Y11 Gc_0 Gc_0))
				...
				(and9x11 (and2_incomplete X9 Y11 Gc_0 Gc_0))
				...
				(and10x11 (and2_incomplete X10 Y11 Gc_0 Gc_0))
				(and11x0 (and2_incomplete X11 Y0 Gc_0 Gc_0))
				(and11x1 (and2_incomplete X11 Y1 Gc_0 Gc_0))
				(and11x2 (and2_incomplete X11 Y2 Gc_0 Gc_0))
				(and11x3 (and2_incomplete X11 Y3 Gc_0 Gc_0))
				(and11x4 (and2_incomplete X11 Y4 Gc_0 Gc_0))
				(and11x5 (and2_incomplete X11 Y5 Gc_0 Gc_0))
				(and11x6 (and2_incomplete X11 Y6 Gc_0 Gc_0))
				(and11x7 (and2_incomplete X11 Y7 Gc_0 Gc_0))
				(and11x8 (and2_incomplete X11 Y8 Gc_0 Gc_0))
				(and11x9 (and2_incomplete X11 Y9 Gc_0 Gc_0))
				(and11x10 (and2_incomplete X11 Y10 Gc_0 Gc_0))
				(and11x11 (and2 X11 Y11 Gc_0 Gc_0))
			)
		(let
			(
				(S0x0 and0x0)
		...
		(let
			(
				(S1x11 ((_ extract 3 2) (fa and11x0 and10x1 C1x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C1x11 ((_ extract 1 0) (fa and11x0 and10x1 C1x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S2x11 ((_ extract 3 2) (fa and9x2 S1x11 C2x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C2x11 ((_ extract 1 0) (fa and9x2 S1x11 C2x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S2x12 ((_ extract 3 2) (fa and11x1 C1x11 C2x11 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C2x12 ((_ extract 1 0) (fa and11x1 C1x11 C2x11 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S3x11 ((_ extract 3 2) (fa and8x3 S2x11 C3x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C3x11 ((_ extract 1 0) (fa and8x3 S2x11 C3x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S3x12 ((_ extract 3 2) (fa and10x2 S2x12 C3x11 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C3x12 ((_ extract 1 0) (fa and10x2 S2x12 C3x11 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S3x13 ((_ extract 3 2) (fa and11x2 C2x12 C3x12 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C3x13 ((_ extract 1 0) (fa and11x2 C2x12 C3x12 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S4x11 ((_ extract 3 2) (fa and7x4 S3x11 C4x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C4x11 ((_ extract 1 0) (fa and7x4 S3x11 C4x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S4x13 ((_ extract 3 2) (fa and10x3 S3x13 C4x12 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C4x13 ((_ extract 1 0) (fa and10x3 S3x13 C4x12 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S4x14 ((_ extract 3 2) (fa and11x3 C3x13 C4x13 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C4x14 ((_ extract 1 0) (fa and11x3 C3x13 C4x13 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S5x11 ((_ extract 3 2) (fa and6x5 S4x11 C5x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C5x11 ((_ extract 1 0) (fa and6x5 S4x11 C5x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S5x14 ((_ extract 3 2) (fa and10x4 S4x14 C5x13 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C5x14 ((_ extract 1 0) (fa and10x4 S4x14 C5x13 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S5x15 ((_ extract 3 2) (fa and11x4 C4x14 C5x14 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C5x15 ((_ extract 1 0) (fa and11x4 C4x14 C5x14 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S6x11 ((_ extract 3 2) (fa and5x6 S5x11 C6x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C6x11 ((_ extract 1 0) (fa and5x6 S5x11 C6x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S6x15 ((_ extract 3 2) (fa and10x5 S5x15 C6x14 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C6x15 ((_ extract 1 0) (fa and10x5 S5x15 C6x14 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S6x16 ((_ extract 3 2) (fa and11x5 C5x15 C6x15 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C6x16 ((_ extract 1 0) (fa and11x5 C5x15 C6x15 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S7x11 ((_ extract 3 2) (fa and4x7 S6x11 C7x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C7x11 ((_ extract 1 0) (fa and4x7 S6x11 C7x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S7x16 ((_ extract 3 2) (fa and10x6 S6x16 C7x15 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C7x16 ((_ extract 1 0) (fa and10x6 S6x16 C7x15 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S7x17 ((_ extract 3 2) (fa and11x6 C6x16 C7x16 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C7x17 ((_ extract 1 0) (fa and11x6 C6x16 C7x16 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S8x11 ((_ extract 3 2) (fa and3x8 S7x11 C8x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C8x11 ((_ extract 1 0) (fa and3x8 S7x11 C8x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S8x17 ((_ extract 3 2) (fa and10x7 S7x17 C8x16 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C8x17 ((_ extract 1 0) (fa and10x7 S7x17 C8x16 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S8x18 ((_ extract 3 2) (fa and11x7 C7x17 C8x17 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C8x18 ((_ extract 1 0) (fa and11x7 C7x17 C8x17 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S9x11 ((_ extract 3 2) (fa and2x9 S8x11 C9x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C9x11 ((_ extract 1 0) (fa and2x9 S8x11 C9x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S9x18 ((_ extract 3 2) (fa and10x8 S8x18 C9x17 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C9x18 ((_ extract 1 0) (fa and10x8 S8x18 C9x17 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S9x19 ((_ extract 3 2) (fa and11x8 C8x18 C9x18 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C9x19 ((_ extract 1 0) (fa and11x8 C8x18 C9x18 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S10x11 ((_ extract 3 2) (fa and1x10 S9x11 C10x10 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C10x11 ((_ extract 1 0) (fa and1x10 S9x11 C10x10 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S10x19 ((_ extract 3 2) (fa and10x9 S9x19 C10x18 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C10x19 ((_ extract 1 0) (fa and10x9 S9x19 C10x18 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S10x20 ((_ extract 3 2) (fa and11x9 C9x19 C10x19 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C10x20 ((_ extract 1 0) (fa and11x9 C9x19 C10x19 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S11x11 ((_ extract 3 2) (ha and0x11 S10x11 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C11x11 ((_ extract 1 0) (ha and0x11 S10x11 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				(S11x20 ((_ extract 3 2) (fa and10x10 S10x20 C11x19 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C11x20 ((_ extract 1 0) (fa and10x10 S10x20 C11x19 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S11x21 ((_ extract 3 2) (fa and11x10 C10x20 C11x20 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C11x21 ((_ extract 1 0) (fa and11x10 C10x20 C11x20 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x12 ((_ extract 3 2) (ha and1x11 S11x12 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x12 ((_ extract 1 0) (ha and1x11 S11x12 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x13 ((_ extract 3 2) (fa and2x11 S11x13 C12x12 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x13 ((_ extract 1 0) (fa and2x11 S11x13 C12x12 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x14 ((_ extract 3 2) (fa and3x11 S11x14 C12x13 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x14 ((_ extract 1 0) (fa and3x11 S11x14 C12x13 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x15 ((_ extract 3 2) (fa and4x11 S11x15 C12x14 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x15 ((_ extract 1 0) (fa and4x11 S11x15 C12x14 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x16 ((_ extract 3 2) (fa and5x11 S11x16 C12x15 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x16 ((_ extract 1 0) (fa and5x11 S11x16 C12x15 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x17 ((_ extract 3 2) (fa and6x11 S11x17 C12x16 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x17 ((_ extract 1 0) (fa and6x11 S11x17 C12x16 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x18 ((_ extract 3 2) (fa and7x11 S11x18 C12x17 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x18 ((_ extract 1 0) (fa and7x11 S11x18 C12x17 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x19 ((_ extract 3 2) (fa and8x11 S11x19 C12x18 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x19 ((_ extract 1 0) (fa and8x11 S11x19 C12x18 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x20 ((_ extract 3 2) (fa and9x11 S11x20 C12x19 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x20 ((_ extract 1 0) (fa and9x11 S11x20 C12x19 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x21 ((_ extract 3 2) (fa and10x11 S11x21 C12x20 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x21 ((_ extract 1 0) (fa and10x11 S11x21 C12x20 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(S12x22 ((_ extract 3 2) (fa and11x11 C11x21 C12x21 Gc_0 Gc_0 Gc_0 Gc_0)))
				(C12x22 ((_ extract 1 0) (fa and11x11 C11x21 C12x21 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				...
				(Z11_1 ((_ extract 1 1) S11x11))
				(Z12_1 ((_ extract 1 1) S12x12))
				(Z13_1 ((_ extract 1 1) S12x13))
				(Z14_1 ((_ extract 1 1) S12x14))
				(Z15_1 ((_ extract 1 1) S12x15))
				(Z16_1 ((_ extract 1 1) S12x16))
				(Z17_1 ((_ extract 1 1) S12x17))
				(Z18_1 ((_ extract 1 1) S12x18))
				(Z19_1 ((_ extract 1 1) S12x19))
				(Z20_1 ((_ extract 1 1) S12x20))
				(Z21_1 ((_ extract 1 1) S12x21))
				(Z22_1 ((_ extract 1 1) S12x22))
				(Z23_1 ((_ extract 1 1) C12x22))
			)
		(let
			(
				...
				(Z20 (concat Z20_1 (bvnot Z20_1)))
				(Z21 (concat Z21_1 (bvnot Z21_1)))
				(Z22 (concat Z22_1 (bvnot Z22_1)))
				(Z23 (concat Z23_1 (bvnot Z23_1)))
			)
        (let
			(
		...
		(let
			(
				...
				(CA21 ((_ extract 1 0) (fa ACC21 Z21 CA20 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(P22 ((_ extract 3 2) (fa ACC22 Z22 CA21 Gc_0 Gc_0 Gc_0 Gc_0)))
				(CA22 ((_ extract 1 0) (fa ACC22 Z22 CA21 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
		(let
			(
				(P23 ((_ extract 3 2) (fa ACC23 Z23 CA22 Gc_0 Gc_0 Gc_0 Gc_0)))
			)
        (let
			(
				...
				(ACCo20_1 ((_ extract 1 1) P20))
				(ACCo21_1 ((_ extract 1 1) P21))
				(ACCo22_1 ((_ extract 1 1) P22))
				(ACCo23_1 ((_ extract 1 1) P23))
			)
        (let
            (
                (ACCncl (concat ACCo23_1 ACCo22_1 ACCo21_1 ACCo20_1 ACCo19_1 ACCo18_1 ACCo17_1 ACCo16_1 ACCo15_1 ACCo14_1 ACCo13_1 ACCo12_1 ACCo11_1 ACCo10_1 ACCo9_1 ACCo8_1 ACCo7_1 ACCo6_1 ACCo5_1 ACCo4_1 ACCo3_1 ACCo2_1 ACCo1_1 ACCo0_1))
            )
        (let
			(
                (Psync (bvmul (concat (_ bv0 12) X11_1 X10_1 X9_1 X8_1 X7_1 X6_1 X5_1 X4_1 X3_1 X2_1 X1_1 X0_1) (concat (_ bv0 12) Y11_1 Y10_1 Y9_1 Y8_1 Y7_1 Y6_1 Y5_1 Y4_1 Y3_1 Y2_1 Y1_1 Y0_1)))
            )
        (let
            (
                (ACCsync (bvadd Psync (concat ACC23_1 ACC22_1 ACC21_1 ACC20_1 ACC19_1 ACC18_1 ACC17_1 ACC16_1 ACC15_1 ACC14_1 ACC13_1 ACC12_1 ACC11_1 ACC10_1 ACC9_1 ACC8_1 ACC7_1 ACC6_1 ACC5_1 ACC4_1 ACC3_1 ACC2_1 ACC1_1 ACC0_1)))
            )
        (=>
            (and
                (= (_ bv0 1) Gc_0)
