...
(declare-fun o_sync () (_ BitVec 16))
(declare-fun o_ncl () (_ BitVec 16))
(declare-fun i_x () (_ BitVec 8))
(declare-fun i_y () (_ BitVec 8))
(declare-fun i_acc () (_ BitVec 16))
(declare-fun o_z () (_ BitVec 16))
	...
	(not
		...
		(let
			(
				...
				(P15 ((_ extract 1 0) (ncl_fa ACC14 Z14 CA13 Gc_0)))
			)
		(let
			(
		...
		(let
			(
				...
				(P15_sync (sync_FA_carry C13_sync (rail1 ACC14) Z14_sync))
			)
		(let
			(
		...
		(=>
			(and
				...
				(datap acci14)
				(datap acci15)
				(= o_ncl (concat (rail1 acc15_1) (rail1 acc14_1) (rail1 acc13_1) (rail1 acc12_1) (rail1 acc11_1) (rail1 acc10_1) (rail1 acc9_1) (rail1 acc8_1) (rail1 acc7_1) (rail1 acc6_1) (rail1 acc5_1) (rail1 acc4_1) (rail1 acc3_1) (rail1 acc2_1) (rail1 acc1_1) (rail1 acc0_1)))
				(= o_sync (concat acc15_1_sync acc14_1_sync acc13_1_sync acc12_1_sync acc11_1_sync acc10_1_sync acc9_1_sync acc8_1_sync acc7_1_sync acc6_1_sync acc5_1_sync acc4_1_sync acc3_1_sync acc2_1_sync acc1_1_sync acc0_1_sync))
				(= i_x (concat (rail1 Xi7) (rail1 Xi6) (rail1 Xi5) (rail1 Xi4) (rail1 Xi3) (rail1 Xi2) (rail1 Xi1) (rail1 Xi0)))
				(= i_y (concat (rail1 Yi7) (rail1 Yi6) (rail1 Yi5) (rail1 Yi4) (rail1 Yi3) (rail1 Yi2) (rail1 Yi1) (rail1 Yi0)))
				(= i_acc (concat (rail1 acci15) (rail1 acci14) (rail1 acci13) (rail1 acci12) (rail1 acci11) (rail1 acci10) (rail1 acci9) (rail1 acci8) (rail1 acci7) (rail1 acci6) (rail1 acci5) (rail1 acci4) (rail1 acci3) (rail1 acci2) (rail1 acci1) (rail1 acci0)))
				(= o_z (concat Z15_1 Z14_1 Z13_1 Z12_1 Z11_1 Z10_1 Z9_1 Z8_1 Z7_1 Z6_1 Z5_1 Z4_1 Z3_1 Z2_1 Z1_1 Z0_1))
			)
			(and
