...
#                print self.gate_info[self.num_gates]['gate_inputs']
#                print gate_op.split(',')
...
#    def rail_connection (self):
#        with open(self.outfile, 'w') as smt2_file:
#            for y in range (1, self.num_gates+1):
#                var= self.gate_info[y]['gate_inputs'].split(',')
#                for x in var:
#                    mat = re.search (r'(?P<variable>[A-z]+)_1.*',x)
#                    m = mat.group ('variable')
#                    nat= re.search (r'(?P<variable>[A-z]+)_0.*', x)
#                    n = nat.group ('variable')
##                    print n
#                    if (m!=n):
#                        smt2_file.write('RAIL ERRORS in' + ' '+ 'gate' + str (y)+ ' ' + 'inputs' +' \n')
#                    else:
#                        smt2_file.write (' NO ERROR IN RAIL CONNECTION \n ')
    @property
...
#                    print n
            ...
            for y in range (1, self.num_gates+1):
                var= self.gate_info[y]['gate_outputs'].split(',')
                for x in var:
                    mat = re.search (r'(?P<variable>[A-z]+)_1.*',x)
                    m = mat.group ('variable')
#                    print m
...
#                    print n
                    if (m!=n):
                        smt2_file.write('RAIL ERRORS in' + ' '+ 'gate' + str (y)+ ' ' + 'outputs' +' \n')    
