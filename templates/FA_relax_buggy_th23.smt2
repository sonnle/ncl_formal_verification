...
(define-fun fa_relax_buggy_th23 ((x (_ BitVec 2)) (y (_ BitVec 2)) (cin (_ BitVec 2)) (gl_3 (_ BitVec 1)) (gl_2 (_ BitVec 1)) (gl_1 (_ BitVec 1)) (gl_0 (_ BitVec 1))) (_ BitVec 4)
    (let
        (
            (gn_0 (bvor (bvand (rail0 x) (rail0 y)) (bvand (rail0 x) (rail0 cin)) (bvand (rail0 y) (rail0 cin))))
            (gn_1 (bvor (bvand (rail1 x) (rail1 y)) (bvand (rail1 x) (rail1 cin)) (bvand (rail1 y) (rail1 cin))))
        )
    (let
        (
